...
def head_to_head(seasons, start_date, end_date):
    """
    Description: 
    ...
    all_seasons_dict = {}
    #seasons = [season]
    start_date_string = str(start_date) + '0'#'201409300' <- Example End Date for 2007
    ...
    for season in seasons:
        ...
        for game_num, game in enumerate(all_season_games):
            if start_date_string in game:
                game_idx = game_num
                break
        
        all_season_games = all_season_games[game_idx:]
